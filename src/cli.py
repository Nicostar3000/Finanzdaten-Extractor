...
from .csv_export import resolve_csv_path, write_transactions_csv
from .gui_viewer import load_and_view
from .transaction_service import collect_pdf_paths, extract_transactions_from_pdfs
from .utils import format_currency, format_quantity
...
class CLIApp:
    ...
    def ausfuehren(self, args):
        ...
        """
        # Die CLI verarbeitet nur Daten, wenn --input gesetzt ist. main.py prueft
        # die Argumentregeln, dieses Modul kuemmert sich um die fachliche Arbeit.
        ...
        # Terminalausgabe und CSV-Export nutzen dieselben extrahierten Rohdaten.
